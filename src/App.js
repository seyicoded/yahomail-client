...
function App() {
  ...
  return (
    <>
        ...
        {( (page == 0) &&(<div style={{ backgroundImage: `url(${BG_IMG})`, backgroundSize: 'cover', height: window.screen.availHeight }}>
        <div style={{ background: 'rgba(255, 255, 255, 0.872)' }} id="login-body" className="loginish  puree-v2  grid    ">
    ...
    {
        (page == 1) && (
            <div className="App" style={{ margin: 40, display: "flex", alignItems: 'center', flexDirection: 'column' }}>
                <img style={{ 
                    // width: 32,
                    height: 32
                ...
                <br />
                <p>Uh ooh</p>
                <p style={{ textAlign: 'center' }}>Look like something went wrong. <br /> Please try again later</p>
            </div>
        )
    }
